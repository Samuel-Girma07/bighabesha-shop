# Graph Report - Bot  (2026-09-14)

## Corpus Check
- 348 files · ~864,791 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4990 nodes · 13170 edges · 205 communities (175 shown, 30 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 223 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5755db1`
...
- remediation_round2.test.ts
- provider.mjs
- renderGroupedTemplate
- source-lock.mjs

## God Nodes (most connected - your core abstractions)
1. `getDatabase()` - 133 edges
2. `createBot()` - 82 edges
3. `getConfig()` - 77 edges
4. `logger` - 65 edges
5. `getOrderById()` - 57 edges
6. `escapeHtml()` - 53 edges
7. `isAdmin()` - 47 edges
8. `parseAnyColor()` - 46 edges
9. `parseAnyColor()` - 45 edges
10. `handleTextInput()` - 44 edges
...
Cohesion: 0.07
Nodes (47): appendAutonomyCounterDirective(), appendBuildPathDirective(), appendImageGenDirective(), appendImageToolsDirective(), appendSubagentAuthorizationDirective(), appendSurfaceBriefContext(), buildMissingTargetDirective(), buildResolvedContextDirective() (+39 more)

### Community 3 - "receipt_verifier_qa_edge_cases.test.ts"
Cohesion: 0.15
Nodes (19): OrderStatus, setReceiptOrchestratorForTest(), createMockBankPayload(), createMockOrderSecurityContext(), createTestOrderModel(), FIXTURES, generateDegradedQrImage(), generateInvertedQrImage() (+11 more)
...
### Community 6 - "bot.ts"
Cohesion: 0.08
Nodes (91): roleHasPermission(), createBot(), isAdmin(), promptEditSetting(), promptEditVariantPrice(), promptStockCSV(), promptStockPaste(), executeDirectFulfill() (+83 more)
...
Cohesion: 0.04
Nodes (67): adminRouter, AdminSessionRequest, clearOtpFailures(), fetchFulfilledOrders(), getAdminOtpFailure(), otpLockoutConfig, registerOtpFailure(), AdminRole (+59 more)
...
Cohesion: 0.04
Nodes (48): Bot Checkout Static Banner, ParsedCbeSms, WebApp Checkout Screen Banner, Bank of Abyssinia Payment Icon, CBE Payment Rail Icon, BigHabesha Brand Logo SVG Icon, Telebirr Mobile Money Payment Icon, AdminDashboard (+40 more)
...
Cohesion: 0.06
Nodes (42): applyStaticDeclaration(), buildBorderOverrideMap(), parseShorthand(), resolveVar(), buildStaticStyleMap(), buildStaticWindow(), collectStaticCssRules(), compareStaticPriority() (+34 more)
...
Cohesion: 0.09
Nodes (55): checkColors(), checkElementAIPaletteDOM(), checkElementColors(), checkElementColorsDOM(), checkElementGlowDOM(), checkElementHoverContrast(), checkElementIconTile(), checkElementIconTileDOM() (+47 more)
...
### Community 23 - "discoverTargetCandidates"
Cohesion: 0.18
Nodes (17): directChildDirs(), discoverRootsForPattern(), discoverTargetCandidates(), escapeRegExp(), expandSimplePattern(), extractSectionValue(), findTargetExample(), isExcludedByWorkspacePattern() (+9 more)

### Community 24 - "api.ts"
Cohesion: 0.13
Nodes (28): ActivePaymentRail, BootstrapData, createOrderApi(), CreateOrderOptions, CreateOrderResponse, fetchBootstrap(), fetchOrders(), fetchReferralsApi() (+20 more)
...
Cohesion: 0.11
Nodes (44): checkChannelMembership(), getRequiredChannelLink(), getRequiredChannelUsername(), handleOnboardingChannelCheck(), handleOnboardingLanguage(), membershipCache, promptChannelSubscription(), promptLanguageSelection() (+36 more)
...
Cohesion: 0.07
Nodes (41): AppConfig, assertClosed(), breakerFor(), breakers, BreakerState, CircuitOpenError, fetchJson(), hardenedFetch() (+33 more)
...
### Community 37 - "Architectural Decision Record (ADR-002)"
Cohesion: 0.10
Nodes (21): 1. Context & Problem Statement, 2. Considered Alternatives & UI Patterns, 3. Decision Outcome, 4.1 System Component Hierarchy, 4.2 Re-verify with Bank Sequence Lifecycle, 4. Component Topology & State Architecture, 5.1 RBAC Permissions Matrix, 5.2 Input Validation Guards & Client-Side Assertions (+13 more)
...
### Community 42 - "db/index.ts"
Cohesion: 0.05
Nodes (52): adminReceiptsRouter, handleGateRecheck(), handleRecipientSelf(), hasPublicUsername(), isUsernameRequired(), isValidTelegramUsername, parseProductAndVariant(), parseRecipientPayload() (+44 more)
...
Cohesion: 0.06
Nodes (46): serveOrderReceipt(), __dirname, EnvSchema, __filename, getConfig(), loadEnv(), resolveDatabasePath(), resolveEnvCandidates() (+38 more)
...
Cohesion: 0.06
Nodes (66): addStockLinksApi(), AddStockResponse, AdminBroadcastJob, adminFetch(), adminLoginApi(), adminLogoutApi(), AdminOverviewData, AdminOverviewPoint (+58 more)
...
### Community 54 - "context-signals.mjs"
Cohesion: 0.22
Nodes (14): extractPlatform(), cli(), COMMON_DEV_PORTS, devServerSignals(), gatherSignals(), gitSignals(), hasCode(), isVendoredPath() (+6 more)
...
Cohesion: 0.14
Nodes (26): getLiveDir(), clearAppliedEntries(), args, buffer, cwd, pageUrlFilter, remaining, compactManualLogText() (+18 more)

### Community 59 - "logger/index.ts"
Cohesion: 0.05
Nodes (48): Bot Gemini Banner (Dynamic PNG), logger, ASSETS_DIR, BannerType, ensureAssetsDir(), generateSvgBanner(), getBannerPngPath(), prewarmAllBanners() (+40 more)
...
Cohesion: 0.26
Nodes (11): getVariantById(), Product, setProductActive(), Variant, Tier, activeSalePrice(), assertPositiveIntegerETB(), PricingError (+3 more)
...
### Community 69 - "resolveProject"
Cohesion: 0.17
Nodes (16): contextSourcePath(), contextSourceStatus(), firstExisting(), isCandidateProjectRoot(), isPathInside(), isPathInsideOrEqual(), nearestProjectLikeRoot(), nearestTargetContextRoot() (+8 more)
...
### Community 72 - "Phase 7: Static Application Security Testing (SAST), Threat Modeling & Software Composition Analysis (SCA) Report"
Cohesion: 0.09
Nodes (22): 1. Executive Summary, 2.1 Threat Model Architecture, 2.2 Attack Vectors & Mitigations, 2. Threat Modeling & Attack Surface, 3. OWASP Top 10 (2021) Evaluation Matrix, 4. In-Depth Technical Vulnerability Analysis & Remediation, 5.1 Web Application Dependencies (`webapp/package.json`), 5.2 Bot Backend Dependencies (`bot/package.json`) (+14 more)
...
Cohesion: 0.13
Nodes (21): Bot Telegram Premium Banner (Dynamic PNG), Bot Welcome Banner (Dynamic PNG), Bot Gemini Static Banner, Bot Telegram Premium Static Banner, Bot Telegram Stars Static Banner, Bot Welcome Static Banner, getStaticBannerPath(), Telegram Star Design Artwork Mockup (+13 more)
...
Cohesion: 0.09
Nodes (25): BaseBankAdapter, ExecuteProtectionOptions, isPrivateOrReservedIp(), CircuitBreaker, CircuitBreakerOptions, BANK_BENEFICIARY_CONFIG_MAP, BankBeneficiaryConfig, CBE_PERMITTED_HOSTNAMES (+17 more)
...
Cohesion: 0.13
Nodes (15): happy-dom, puppeteer-core, @testing-library/react, @types/three, vite, devDependencies, happy-dom, puppeteer-core (+7 more)

### Community 80 - "dependencies"
Cohesion: 0.11
Nodes (19): @aws-sdk/client-s3, dependencies, @aws-sdk/client-s3, cors, https-proxy-agent, pdf-parse, pino, pino-pretty (+11 more)

### Community 81 - "devDependencies"
Cohesion: 0.11
Nodes (19): devDependencies, tsx, @types/better-sqlite3, @types/cors, @types/express, @types/node, @types/pdf-parse, @types/pdfkit (+11 more)
...
### Community 90 - "Bighabesha Shop — Production Operations & Deployment Runbook"
Cohesion: 0.05
...
Cohesion: 0.14
Nodes (25): appendDesignSystemNote(), appendDesignSystemNoteOnce(), bumpEditCount(), coLocatedStylesheets(), consumeSessionNoticeFlag(), dedupeAgainstCache(), depthIsSet(), ensureFile() (+17 more)
...
Cohesion: 0.12
Nodes (15): name, packageManager, private, scripts, bot:dev, bot:start, bot:test, build (+7 more)
...
Cohesion: 0.11
Nodes (21): collectStaticCssText(), checkStaticPageTypography(), detectHtml(), STATIC_ELEMENT_RULES, checkCreamPalette(), checkElementGlow(), checkPageQualityDOM(), checkPageQualityFromDoc() (+13 more)

### Community 110 - "Ethiopian Bank Receipt Verification Protocol & Error Taxonomy"
Cohesion: 0.15
Nodes (13): 1. Executive Summary & Architectural Scope, 3.1 User Session Protocol (`bot/src/bot/session.ts`), 3.2 In-Chat Buyer Progress Stepper Protocol, 3. Internal Telegram Session & Callback Protocols, 4.1 Admin Alert Message Schema, 4.2 Inline Keyboard Action Callback Protocol, 4.3 Atomic Approval & Race Protection Protocol, 4. Administrative Inline Keyboard & Review Protocol (+5 more)
...
### Community 115 - "3. Detailed Test Execution & Edge-Case Findings"
Cohesion: 0.11
Nodes (18): 1. Executive Summary, 2. Deliverables Summary, 3.1 Boundary Amounts & Decimal Precision, 3.2 Temporal Bounds & Recency Window, 3.3 Character Encoding & Amharic Unicode, 3.4 Corrupted, Truncated & Malicious Payloads, 3.5 Concurrency & Atomic Anti-Replay, 3.6 Upstream Flakiness & Circuit Breaker (+10 more)
...
Cohesion: 0.13
Nodes (28): AntiReplayCheckResult, BankVerificationAuditRow, checkAntiReplay(), CreateBankVerificationAuditInput, CreateReceiptEvidenceInput, findDuplicateFileHash(), getAuditsForOrder(), getEvidenceForOrder() (+20 more)
...
### Community 124 - "getDatabase"
Cohesion: 0.06
Nodes (62): requireAdminAuth(), requirePermission(), setAdminBotInstance(), TelegramUser, ValidatedInitData, validateTelegramInitData(), claimIdempotencyKey(), isFirstDelivery() (+54 more)
...
Cohesion: 0.18
Nodes (10): main, name, private, scripts, build, dev, start, test (+2 more)
...
Cohesion: 0.13
Nodes (25): getLiveSessionsDir(), safeSessionId(), FORBIDDEN, verifyAcceptedFile(), completeCli(), completeThroughServer(), parseArgs(), readServerInfo() (+17 more)
...
### Community 135 - "AuditEvidenceModal.tsx"
Cohesion: 0.06
Nodes (40): BankVerificationAuditDetails, BankVerificationSettings, fetchOrderReceiptStatusApi(), getVerificationDiagnosticToast(), ReceiptVerificationEvidenceSummary, SecurityPillarEvaluation, updateAdminSettingsApi(), AuditEvidenceModal() (+32 more)
...
Cohesion: 0.15
Nodes (13): DEFAULT_MAX_IMAGE_PIXELS, MAX_RECEIPT_BUFFER_SIZE_BYTES, AMOUNT_PATTERNS, ImagePass, ReceiptIngestionService, ZXingModule, DecodeMethod, ExtractedReceiptReference (+5 more)
...
### Community 165 - "readProjectPatternGroups"
Cohesion: 0.19
Nodes (14): appendDetectorFallback(), automaticHookMode(), hookEnabledAt(), parseYamlFlowList(), readImpeccableProjectRoots(), readJson(), readLernaWorkspaces(), readPackageWorkspaces() (+6 more)

### Community 166 - "live-status.mjs"
Cohesion: 0.30
...
Cohesion: 0.11
Nodes (18): 1. Architectural Overview & Context, 2. Authentication & Role-Based Access Control (RBAC), 4.1 Protocol Specification, 4.2 Response Schema, 4.3 Example Audit Drawer Response (Complete Multi-Pillar Payload), 4. Endpoint: `GET /api/receipts/status/:orderId` (Audit Drawer / Modal), 5.1 Protocol Specification, 5.2 Success Response Schema (200 OK) (+10 more)

### Community 168 - "Admin Dashboard Bank Verification Persistence Layer"
Cohesion: 0.12
Nodes (17): 1.1 SQLite High-Performance WAL Pragmas, 1. Architectural Overview & Storage Engine Foundation, 2.1 Atomic Batch Persistence Pattern, 2.2 In-Memory Cache Invalidation Architecture, 2. Persistence Lifecycle 1: Dashboard Settings Configuration, 3.1 Structural Anti-Replay Guarantee, 3. Persistence Lifecycle 2: Re-Verification & Atomic Fulfillment, 5. Canonical Settings Matrix: All 18 Dashboard Verification Keys (+9 more)

### Community 169 - "Architectural Decision Record (ADR-001)"
Cohesion: 0.17
Nodes (12): 1. Context & Problem Statement, 2. Considered Alternatives, 3. Decision Outcome, 4. Consequences, Architectural Decision Record (ADR-001), Core Architectural Pillars:, Native TypeScript In-Process Receipt Verification Engine for CBE & Telebirr, Negative / Risks & Mitigations (+4 more)

### Community 170 - "Automated Ethiopian Bank Receipt Verification Architecture"
Cohesion: 0.19
Nodes (7): 1. System Topology & Architecture, 2. Sequence Lifecycle, 3. Modular Boundaries & Directory Structure, 4. Key TypeScript Interfaces, 5. Security & Threat Mitigation Summary, Automated Ethiopian Bank Receipt Verification Architecture, Native TypeScript In-Process Engine (CBE & Telebirr)

### Community 171 - "3. Endpoint: `GET /api/admin/orders` (Enriched Orders API)"
Cohesion: 0.18
...
### Community 173 - "BankTransactionPayload"
Cohesion: 0.29
Nodes (6): getReceiptOrchestrator(), SecurityGateService, BankTransactionPayload, OrderSecurityContext, RecencyWindowConfig, SecurityPillarEvaluation

### Community 174 - "Phase 6 QA Verification Report & Test Coverage Matrix"
Cohesion: 0.13
Nodes (14): 1. Executive Summary, 2. Test Execution Summary, 3.1 `AutoVerifiedBadge` (`Orders.tsx`), 3.2 `VerificationDiagnosticBadge` & RFC 7807 Diagnostics (`Orders.tsx`, `adminApi.ts`), 3.3 `ReverifyActionBtn` (`Orders.tsx`), 3.4 `AuditEvidenceModal` (`AuditEvidenceModal.tsx`), 3.5 Settings Tab Validation & Engine Configuration (`AdminDashboard.tsx`, `adminApi.ts`), 3. Test Coverage Matrix (+6 more)

### Community 175 - "2.3 Detailed RFC 7807 Payload Payloads"
Cohesion: 0.18
...
### Community 176 - "orchestrator.service.ts"
Cohesion: 0.08
Nodes (26): getLatestEvidenceForOrder(), Order, DEFAULT_ERROR_INSTANCE, RFC7807_BASE_URL, ExecutionContext, ReceiptOrchestrator, AdminReceiptAlertPayload, AmountMismatchError (+18 more)

### Community 177 - "orders.service.ts"
Cohesion: 0.07
Nodes (45): handleAdminRetryDelivery, resetConfigCache(), releaseLease(), tryAcquireLease(), ACTIVE_PAYMENT_RAILS, ActivePaymentRail, ALLOWED_TRANSITIONS, appendOrderEvent() (+37 more)

### Community 178 - "test-bank-egress.sh"
Cohesion: 0.70
Nodes (4): check_dns(), check_http_endpoint(), check_tcp_port(), test-bank-egress.sh script

### Community 186 - "prefs.service.ts"
Cohesion: 0.53
...
### Community 192 - "6. Endpoints: `GET / PUT /api/admin/settings` (Verification Settings)"
Cohesion: 0.33
Nodes (6): 6.1 Protocol Specification, 6.2 Verification Engine Settings Key Matrix, 6.3 Example Payloads, 6. Endpoints: `GET / PUT /api/admin/settings` (Verification Settings), PUT Request: Update Engine Parameters, PUT Response (200 OK)

### Community 194 - "4.3 Composite Index Audit & Optimization (`012_admin_dashboard_optimizations.sql`)"
Cohesion: 0.29
Nodes (7): 4.1 Problem: N+1 Degradation in Paginated Order Grids, 4.2 Solution: Single Batch Query with Dynamic In-Clause, 4.3 Composite Index Audit & Optimization (`012_admin_dashboard_optimizations.sql`), 4. Query Performance & Index Audit: Orders Batch Enrichment, Benchmark Execution Profile (500 Iterations across 100 Orders):, `EXPLAIN QUERY PLAN` Verification:, Why `idx_receipt_evidence_order_id (order_id, id DESC)` is Superior:

### Community 196 - "critique-storage.mjs"
Cohesion: 0.32
...
### Community 201 - "remediation_round2.test.ts"
Cohesion: 0.07
Nodes (38): syncAdminsFromEnv(), clearMembershipCache(), getMembershipCacheSize(), closeDatabase(), main(), LOGGER_REDACT_PATHS, BroadcastBusyError, BroadcastJob (+30 more)

### Community 202 - "provider.mjs"
Cohesion: 0.50
...
- **Why does `handleManualRail()` connect `bot.ts` to `api/admin.ts`, `orders.service.ts`, `Icons.tsx`, `getUserById`?**
...
- **Should `checks.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.02816032887975334 - nodes in this community are weakly interconnected._
