...
export async function renderSupport(ctx: Context): Promise<void> {
  ...
  const text = isAmharic
    ? '<b>✨ ━━━━━ ʙɪɢʜᴀʙᴇꜱʜᴀ ꜱʜᴏᴘ ━━━━━ ✨</b>\n\n' +
      ...
      `• 💳 <b>ተቀባይነት ያላቸው ክፍያዎች፦</b> ቴሌብር፣ ንግድ ባንክ (CBE)\n` +
    ...
    : '<b>✨ ━━━━━ ʙɪɢʜᴀʙᴇꜱʜᴀ ꜱʜᴏᴘ ━━━━━ ✨</b>\n\n' +
      ...
      `• 💳 <b>Supported Rails:</b> Telebirr & CBE Bank\n` +
...
export async function renderHelp(ctx: Context): Promise<void> {
  const text =
    ...
    '3. Choose your payment method (Telebirr or CBE Bank)\n' +
    '4. Complete the transfer, then send the SMS confirmation text or transaction reference\n\n' +
